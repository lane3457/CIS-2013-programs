...
var vowels = function () 
{
    ...
    {
        var intVowels = 0;
        for( var intCount = 0; intCount < stringEntry.lenght; intCount++)
    {
    ...
    $("output").value = "there are" + intVowels + "vowels in the abovce phrase";
    }
    }
...
var reverse = function () 
{
    ...
    {
        var stringReversed = "";
        for(var intCount = stringEntry - 1; intCount >=0 ; intCount --)
        {
            stringReversed = stringReversed + stringEntry.charAt(intCount);
        }
         $("output").value = "the reversed of the above phrase is: \n" + stringReversed;  
    }
}
